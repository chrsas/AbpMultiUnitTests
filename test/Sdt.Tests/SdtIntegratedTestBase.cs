...
namespace Sdt.Tests
{
    ...
    /// </summary>
    public abstract class SdtIntegratedTestBase<TStartupModule> : IDisposable
        where TStartupModule : AbpModule
    {
        ...
        protected AbpBootstrapper AbpBootstrapper { get; set; }
        ...
        protected SdtIntegratedTestBase(bool initializeAbp = true)
        {
