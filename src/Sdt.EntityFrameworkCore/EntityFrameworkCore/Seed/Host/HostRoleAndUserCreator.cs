...
namespace Sdt.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        private readonly SdtDbContext _context;

        public HostRoleAndUserCreator(SdtDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new SdtAuthorizationProvider(),
                    new DealerAppAuthorizationProvider(),
                    new DealerSalesInfoAppAuthorizationProvider())
